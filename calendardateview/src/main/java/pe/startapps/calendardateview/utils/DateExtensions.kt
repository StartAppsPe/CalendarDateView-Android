...
const val dateFormat0 = "yyyy-MM-dd'T'HH:mm:ssZ"
...
fun Calendar.dateByAddingMonths(months: Int): Calendar {
    add(Calendar.MONTH, months)
    return this
}

fun Calendar.dateByAddingWeeks(weeks: Int): Calendar {
    add(Calendar.WEEK_OF_YEAR, weeks)
    return this
}

fun Calendar.dateBySubtractingMonths(months: Int): Calendar {
    add(Calendar.MONTH, -months)
    return this
}
