...
import pe.startapps.calendardateview.CalendarDateView;

/**
 * Created by LiFei on 2017/2/7.
 */

public class CalendarLayout2 extends FrameLayout {

    private static final String TAG = "CalendarLayout";

    private View view1;
    private ViewGroup view2;
    private CalendarDateView mTopView;
    //展开
    ...
    public CalendarLayout2(Context context) {
        super(context);
        init();
    }

    public CalendarLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onFinishInflate() {
        ...
        final CalendarDateView viewPager = (CalendarDateView) getChildAt(0);
        ...
        /*mTopView.setCalendarTopViewChangeListener(new CalendarTopViewChangeListener() {
            @Override
            public void onLayoutChange(CalendarTopView calendarView) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        itemHeight = mTopView.getCalendarItemHeight();
        ...
        view2.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(heightMeasureSpec) - mTopView.getCalendarItemHeight(), MeasureSpec.EXACTLY));
    }
...
//        mViewDragHelper.shouldInterceptTouchEvent(ev);
    ...
    public void processTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                float crrentV = mVelocityTracker.getYVelocity(pointerId);
    ...
    private void move(int dy) {
        ...
        int itemHeight = mTopView.getCalendarItemHeight();
